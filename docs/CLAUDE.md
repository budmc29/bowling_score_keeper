...
YOU MUST ALWAYS perform a complete root cause analysis BEFORE attempting any fix, even for issues that seem simple or obvious.
When you identify the root cause, YOU MUST confirm your analysis and proposed fix with Theo before implementing.

Once you solve an error, YOU MUST review the entire codebase for similar issues and fix them proactively. Don't just fix the single instance that caused the immediate problem.

YOU MUST follow this debugging framework for ANY technical issue:

### Phase 0: Check Known Issues (FIRST STEP)
- **Consult docs/KNOWN_ISSUES.md**: Before investigating, check if this is a known issue with a documented solution
- **Match Symptoms**: Compare your issue's symptoms against documented issues
- **Apply Known Fixes**: If it matches a known issue, apply the documented solution
- **Update Documentation**: If you solve a new difficult issue, YOU MUST add it to KNOWN_ISSUES.md
